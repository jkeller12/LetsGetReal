public class Tester {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            RealNumber num_ZERO = new RealNumber(0);
            RealNumber other1 = new RealNumber(0.000000001);

            check(test, num_ZERO.equals(other1), false);
    ...
    //    test = "Find Error- num_ZERO TING"
        ...
        try {
            ...
            check(test, num.getValue(), (double) 0 / 1);
        } catch(RuntimeException e) {
            except(test, e);
        }
